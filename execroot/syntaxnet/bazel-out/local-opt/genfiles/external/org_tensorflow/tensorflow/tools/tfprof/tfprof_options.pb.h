...
class OptionsProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.tfprof.OptionsProto) */ {
 public:
  ...
  #if LANG_CXX11
  void set_device_regexes(int index, ::std::string&& value);
  #endif
  ...
  #if LANG_CXX11
  void add_device_regexes(::std::string&& value);
  #endif
...
#if LANG_CXX11
inline void OptionsProto::set_device_regexes(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:tensorflow.tfprof.OptionsProto.device_regexes)
...
#if LANG_CXX11
inline void OptionsProto::add_device_regexes(::std::string&& value) {
